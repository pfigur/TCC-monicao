...
class ControllerCadastroFuncio extends ClassFuncionario {
    ...
    public function addFuncionario(){
        ...
        #}else{
            ...
            $this->salvarFuncionario($this->nome,$this->cpf,$this->rg,$this->celular,$this->email,$this->endereco,$this->funcao_id,$this->ativo);
            #$this->usuario = new ClassUsuario();
            #$this->usuario->addUsuario($this->login,$this->senha,$this->ativo,$this->nivelacesso_id,$this->funcionario_id);
        #}
