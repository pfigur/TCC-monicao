...
class ClassFuncionario extends ClassConexao{
    ...
    protected function salvarFuncionario($nome,$cpf,$rg,$celular,$email,$endereco,$funcao_id,$ativo){
        $funcionario_id=0;
        $BFetch=$this->db=$this->conexaoDB()->prepare("INSERT INTO funcionarios VALUES(:funcionario_id,:nome, :cpf, :rg, :celular,:email,:endereco,:funcao_id,:ativo, NOW(), null)");
